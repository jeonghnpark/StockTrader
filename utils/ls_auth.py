...
APP_FUTURES_KEY_TEST = os.getenv("EBEST-OPEN-API-APP-KEY-FUTURES-TEST") or os.getenv(
    "EBEST_OPEN_API_APP_KEY_FUTURES_TEST"
)
APP_FUTURES_SECRET_TEST = os.getenv(
    "EBEST-OPEN-API-SECRET-KEY-FUTURES-TEST"
) or os.getenv("EBEST_OPEN_API_SECRET_KEY_FUTURES_TEST")

EBEST_OPEN_API_APP_KEY = os.getenv("EBEST-OPEN-API-APP-KEY") or os.getenv(
    "EBEST_OPEN_API_APP_KEY"
)
EBEST_OPEN_API_SECRET_KEY = os.getenv("EBEST-OPEN-API-SECRET-KEY") or os.getenv(
    "EBEST_OPEN_API_SECRET_KEY"
)
